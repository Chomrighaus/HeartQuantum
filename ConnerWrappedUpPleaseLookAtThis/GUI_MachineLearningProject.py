...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        for F in (MainMenu, GraphsWindow, AccuracyMatrixWindow, RandomForestWindow,
                  KNNWindow, NaiveBayesWindow, LogisticRegressionWindow, SVCWindow,
                  AccuracyComparisonWindow, DataEntryWindow, EndPresentationWindow):
...
class GraphsWindow(tk.Frame):
    def __init__(self, parent, controller):
        super().__init__(parent)
        label = tk.Label(self, text="Graphs!", font=("Arial", 18))
        label.pack(pady=10)
...
class AccuracyMatrixWindow(tk.Frame):
    def __init__(self, parent, controller):
        super().__init__(parent)
        label = tk.Label(self, text="Accuracy and Confusion Matrix!", font=("Arial", 18))
        label.pack(pady=10)
...
class SVCWindow(BaseDetailWindow):
    def __init__(self, parent, controller):
        super().__init__(parent, controller, "Support Vector Classifier", "SVC")
